...
![cookie](/react-sdk-demo/readme-assets/cookie.png)
...
-   `use-sync-external-store` (hook for interface with `zustand` store)
...
![breadcrumb](/react-sdk-demo/readme-assets/breadcrumbs-categories.png)

File: [`FormSelectionBreadcrumb.tsx`](./src/components/FormSelectionBreadcrumb.tsx)
...
![filter](/react-sdk-demo/readme-assets/filter-categories.png)

File: [`FormSelectionFilter.tsx`](./src/components/FormSelectionFilter.tsx)
...
![form-card](/react-sdk-demo/readme-assets/form-card.png)

File: [`FormCards.tsx`](./src/components/FormCards.tsx)
...
![form](/react-sdk-demo/readme-assets/form.png)

File: [`ConfigComponent.tsx`](./src/pages/ConfigComponent.tsx)
...
![config-panel-steps](/react-sdk-demo/readme-assets/config-panel-steps.png)
...
File: [`CheckoutComponent.tsx`](./src/pages/CheckoutComponent.tsx)

#### Contact details

![contact-details](/react-sdk-demo/readme-assets/contact-details.png)
...
![bom](/react-sdk-demo/readme-assets/bom.png)
